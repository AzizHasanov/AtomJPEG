...
<link href="<results:url value="/resources/css/result.css" />"rel="stylesheet">
<link href="<results:url value="/resources/css/twentytwenty.css" />"rel="stylesheet">
<!--  js files -->
<script
...
<script src="<results:url value="resources/js/jquery.twentytwenty.js"/>"></script>
...
window.onload = function(){
	$("a").click(function(){
	  ...
	  setTimeout(function(){$(".20_container").twentytwenty();},
